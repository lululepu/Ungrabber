...
class Stub:
    """
    The stub class to handle .pyc file and .exe file
    """
    ...
    def generateStruct(self) -> None:
        ...
        if not self.isExe:
            ...
            return
        self.struct, self.version = unpack(self.content)
    ...
    def getType(self) -> str:
        ...
        self.type = next(
            (t[0] for t in grabber_types if t[2](s in self.struct for s in t[1])), None
        )
